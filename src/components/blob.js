      ...
      <animated.path
        ...
        d={x.to({
          ...
          output: [
            ...
            "M162.8 -171.8C193.7 -132 189.3 -66 179.1 -10.3C168.8 45.5 152.6 91 121.8 126.8C91 162.6 45.5 188.8 -12.6 201.4C-70.7 214 -141.4 213.1 -168.9 177.3C-196.4 141.4 -180.7 70.7 -163 17.7C-145.4 -35.4 -125.7 -70.7 -98.2 -110.5C-70.7 -150.4 -35.4 -194.7 15.3 -210C66 -225.3 132 -211.7 162.8 -171.8"
          ],
        })}
      />
    </svg>
